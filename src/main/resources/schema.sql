...
DROP EVENT IF EXISTS remove_expired_download_token;
...
ALTER TABLE parameter_metadata
    ADD CONSTRAINT cu_pmd_on_smd_idx UNIQUE (sensor_metadata_id, idx);

ALTER TABLE user
    ADD CONSTRAINT cu_user_on_mail UNIQUE (mail);

ALTER TABLE refresh_token
    ADD CONSTRAINT fk_rt_to_u FOREIGN KEY (user_id) REFERENCES user (id);

ALTER TABLE refresh_token
    ADD CONSTRAINT cu_rt_on_token UNIQUE (token);

ALTER TABLE download_token
    ADD CONSTRAINT fk_dt_to_u FOREIGN KEY (user_id) REFERENCES user (id);

ALTER TABLE download_token
    ADD CONSTRAINT fk_dt_to_s FOREIGN KEY (sensor_id) REFERENCES sensor (id);

ALTER TABLE download_token
    ADD CONSTRAINT cu_dt_on_token UNIQUE (token);

ALTER TABLE parameter
    ADD CONSTRAINT fk_p_to_pmd FOREIGN KEY (parameter_metadata_id) REFERENCES parameter_metadata (id);

ALTER TABLE parameter
    ADD CONSTRAINT fk_p_to_s FOREIGN KEY (sensor_id) REFERENCES sensor (id);

ALTER TABLE parameter_metadata
    ADD CONSTRAINT fk_pmd_to_smd FOREIGN KEY (sensor_metadata_id) REFERENCES sensor_metadata (id);

ALTER TABLE sensor
    ADD CONSTRAINT fk_s_to_smd FOREIGN KEY (sensor_metadata_id) REFERENCES sensor_metadata (id);

ALTER TABLE sensored_bulk_data
    ADD CONSTRAINT fk_sbd_to_s FOREIGN KEY (sensor_id) REFERENCES sensor (id);


ALTER TABLE access_sensor
    ADD CONSTRAINT fk_as_to_s FOREIGN KEY (sensor_id) REFERENCES sensor (id);

ALTER TABLE access_sensor
    ADD CONSTRAINT fk_as_to_a FOREIGN KEY (access_id) REFERENCES access (id);

ALTER TABLE access_user
    ADD CONSTRAINT fk_au_to_u FOREIGN KEY (user_id) REFERENCES user (id);

ALTER TABLE access_user
    ADD CONSTRAINT fk_au_to_a FOREIGN KEY (access_id) REFERENCES access (id);

ALTER TABLE interact_sensor
    ADD CONSTRAINT fk_is_to_u FOREIGN KEY (user_id) REFERENCES user (id);

ALTER TABLE interact_sensor
    ADD CONSTRAINT fk_is_to_s FOREIGN KEY (sensor_id) REFERENCES sensor (id);

ALTER TABLE interact_user
    ADD CONSTRAINT fk_iu_to_u FOREIGN KEY (user_id) REFERENCES user (id);

ALTER TABLE interact_user
    ADD CONSTRAINT fk_iu_to_t FOREIGN KEY (target_id) REFERENCES user (id);

ALTER TABLE interact_access
    ADD CONSTRAINT fk_ia_to_u FOREIGN KEY (user_id) REFERENCES user (id);

ALTER TABLE interact_access
    ADD CONSTRAINT fk_ia_to_t FOREIGN KEY (access_id) REFERENCES access (id);
...
CREATE EVENT remove_expired_download_token
    ON SCHEDULE EVERY 1 HOUR DO
    DELETE FROM download_token
    WHERE expiration < DATE_ADD(NOW(), INTERVAL 1 DAY); -- Add interval for prevent timezone differance
