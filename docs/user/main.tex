...
\chead{
\href{https://www.ummisco.fr}{\includegraphics[height=16px]{resources/ummisco.png}}
\href{https://www.ird.fr}{\includegraphics[height=16px]{resources/ird.png}}
}
...
\begin{document}
    ...
    \input{parties/01_home}
    \input{parties/02_list}
    \input{parties/03_map}
\end{document}
